  ...
  async function login(email, password) {
    ...
    try {
      ...
      if (res.status.code === 200 && res.data) {
        const loggedUser = {
          id: res.data.id, nama: res.data.nama, email: res.data.email,
          role: res.data.role, jabatan: res.data.jabatan,
          posyandu: res.data.posyandu, namaAnak: res.data.namaAnak,
          token: res.data.token, refreshToken: res.data.refreshToken,
        };
      ...
      // ← hapus 'err' karena tidak dipakai, langsung catch kosong
