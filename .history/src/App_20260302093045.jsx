...
const PAGE_TITLES = {
  dashboard:'Dashboard', balita:'Data Balita', pemantauan:'Pemantauan Tumbuh Kembang',
  stunting:'Analisis Stunting', jadwal:'Jadwal Posyandu', laporan:'Laporan',
  ...
  function renderPage() {
    ...
    switch (activePage) {
      ...
      case 'pengguna':   return (
        <PenggunaPage
          users={pengguna.filtered}
          onToggleAktif={pengguna.toggleAktif}
          onDelete={pengguna.deleteUser}
          onAdd={pengguna.addUser}
        />
      );
