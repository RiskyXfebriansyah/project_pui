  ...
  async function exportExcel() {
    ...
    try {
      ...
      const ws2=XLSX.utils.aoa_to_sheet([
        ...
        [`Posyandu: ${info.namaPosyandu}  •  Bulan: ${info.bulan} ${info.tahun}`],
        [],
        ['No','No KK','NIK','Anak Ke','Nama Anak','Tgl Lahir','L/P','Usia Kehamilan saat lahir','BBL','PBL','UKA','Nama Ortu','NIK Ayah','No Tlp','Alamat','RT','RW','Tgl Ukur Lalu','BB Lalu','TB Lalu','Tgl Ukur Baru','BB Baru','TB/PB Baru','LILA','LIKA','N/T/O/B','ASI','VitA Feb','Buku KIA','Ket Perkembangan','PKAT','Status Stunting'],
        ...pemRows.map((r,i)=>[
              ...
              <thead>
                <tr>
                  ...
                  {[
                    ...
                    {l:'saat ',w:52},{l:'BBL',w:46},{l:'PBL',w:46},{l:'UKA',w:46},
