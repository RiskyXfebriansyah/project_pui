      ...
      if (res?.status?.code === 200 && res.data) {
        ...
        if (d.kegiatan) {
          ...
          setKegiatan({
            ...
            vitA_bayi_feb:k.vitA_Bayi_Feb||'',:k.||'',
  ...
  async function exportExcel() {
    ...
    try {
      ...
      const ws1 = XLSX.utils.aoa_to_sheet([
        ...
        [],
        ['BGM',kegiatan.bawahGarisMerah,'Vit A Bayi Feb',kegiatan.vitA_bayi_feb,'Vit A Bayi Ags',kegiatan.,'Vit A Balita Feb',kegiatan.vitA_balita_feb,'Vit A Balita Ags',kegiatan.vitA_balita_ags],
    ...
    <div style={{ padding:24, fontFamily:'inherit' }}>
      ...
      <Card style={{ marginBottom:16 }}>
        ...
        <div style={{ display:'grid', gridTemplateColumns:'repeat(4,1fr)', gap:'0 20px', marginTop:20, paddingTop:16, borderTop:'1px solid #F0F0F0' }}>
          ...
          <Field label="Vit A Bayi — Ags" type="number" min="0" value={kegiatan.} onChange={v=>setKegiatan(p=>({...p,:v}))}/>
