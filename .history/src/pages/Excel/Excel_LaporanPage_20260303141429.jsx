...
function sheet1(info, keg, asi, gizi) {
  ...
  [
    ...
    // Anchor merge: border outline dari anchor cell sudah cukup untuk all-border pada merged cell
    ...
    rows.push([
      ...
      mergeAnchor,                      // col 2 — anchor C (border outline)
      ...Array(TC-3).fill(null),        // col 3–13 — null (dalam merge)
    ]);
