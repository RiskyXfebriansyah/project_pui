...
function setPrintLandscape(ws) {
  ws['!pageSetup'] = {
    orientation: 'landscape',   // HORIZONTAL (landscape)
    paperSize:   9,             // A4
    fitToWidth:  1,             // muat 1 halaman lebar
    fitToHeight: 0,             // tinggi bebas (sesuai konten)
    fitToPage:   true,
    scale:       100,
  };
  ws['!printOptions'] = {
...
export async function exportLaporanExcel({ info, kegiatan, asiRows, giziRows, pemRows, extraData={} }) {
  ...
  // Set semua sheet landscape (horizontal)
  setPrintLandscape(ws1);
  setPrintLandscape(ws2);
  setPrintLandscape(ws3);
