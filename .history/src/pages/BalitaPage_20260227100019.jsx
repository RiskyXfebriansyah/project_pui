...
export default function BalitaPage({ balita, onAddPemantauan, onAddBalita, onDelete, role }) // eslint-disable-line {
      ...
      <Card>
        <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:16 }}>
          ...
          <div style={{ display:'flex', gap:10 }}>
            ...
            {!onAddBalita && (
              <span style={{fontSize:12,color:'#9E9E9E',padding:'8px 0'}}>
                👁️ Mode lihat saja
              </span>
            )}
          </div>
