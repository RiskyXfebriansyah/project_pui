...
//  - Import exportLaporanExcel dari ./ExcelLaporanPage
//  - Tombol export tidak lagi disabled (bisa export kapan saja)
// ============================================================
...
import { exportLaporanExcel } from './Excel/ModalExcelInfo';
...
export default function LaporanPage({ balitaList = [], currentUser = null }) {
  ...
  // ── Export Excel — pakai ExcelLaporanPage.jsx ───────────────
    ...
    <div style={{ padding:24, fontFamily:'inherit' }}>
      ...
      <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start', marginBottom:20 }}>
        ...
        <div style={{ display:'flex', gap:10 }}>
          ...
          {/* Export Excel — tidak perlu saved dulu */}
