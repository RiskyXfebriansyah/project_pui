...
//  Padanan: V_login.dart di Flutter
//
//  Di Flutter  → ConsumerStatefulWidget + Form
//  Di React    → functional component + useState
// ============================================================

import React, { useState } from 'react';

// DEMO ACCOUNTS — klik untuk isi otomatis
const DEMO_ACCOUNTS = [
...
export default function LoginPage({ onLogin }) {
  // useState = padanan TextEditingController + _obscure di Flutter
  ...
  // Isi form otomatis dari demo account
  ...
  // Proses login — padanan _login() di Flutter
  async function handleLogin(e) {
    ...
    if (!ok) { setError('Email atau password salah'); setLoading(false); }
  }
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* Decorative circles */}
        {[[-80,-80,300],[60,'auto',200,0,undefined,200],['auto',-60,150]].map((c,i)=>
          <div key={i} style={{
            position:'absolute', width:c[2], height:c[2],
            top:c[0]==='auto'?'auto':c[0], left:c[1]==='auto'?'auto':c[1],
            right:c[4], bottom:c[5],
