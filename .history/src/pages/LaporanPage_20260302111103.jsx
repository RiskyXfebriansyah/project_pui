            ...
            <tbody>
              {asiRows.map((r, i) => (
                <tr key={i}>
                  ...
                  <input type="date" value={r.tglLahir} onChange={e => {const tglLahir = e.target.value;const umurOtomatis = hitungUmurDariTglLahir(tglLahir);setAsiRows(p => p.map((x, j) => j === i ? { ...x, tglLahir, umur: String(umurOtomatis) } : x));}}style={{ ...txtIn, width:120 }}
/></td>
