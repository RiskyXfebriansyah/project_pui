...
const defaultKegiatan = () => ({
  ...
  bawahGarisMerah:'',vitA_bayi_feb:'',vitAAgs:'',bukuKIA:'',ketPerkembangan:'',
  ...
  async function exportExcel() {
    ...
    try {
      ...
      const ws1 = XLSX.utils.aoa_to_sheet([
        ...
        [],
        ['BGM',kegiatan.bawahGarisMerah,'Vit A Bayi Feb',kegiatan.vitA_bayi_feb,'Vit A Bayi Ags',kegiata','Vit A Balita Feb',kegiatan.,'Vit A Balita Ags',kegiatan],
    ...
    <div style={{ padding:24, fontFamily:'inherit' }}>
      ...
      <Card style={{ marginBottom:16 }}>
        ...
        <div style={{ display:'grid', gridTemplateColumns:'repeat(4,1fr)', gap:'0 20px', marginTop:20, paddingTop:16, borderTop:'1px solid #F0F0F0' }}>
          ...
          <Field label="Vit A Balita — Feb" type="number" min="0" value={kegiatan.} onChange={v=>setKegiatan(p=>({...p,:v}))}/>
          <Field label="Vit A Balita — Ags" type="number" min="0" value={kegiatan} onChange={v=>setKegiatan(p=>({...p:v}))}/>
