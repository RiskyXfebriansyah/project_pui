...
const defaultKegiatan = () => ({
  ...
  bawahGarisMerah:'',vitA_bayi_feb:'',vitA_balita_ags:'',
      ...
      if (res?.status?.code === 200 && res.data) {
        ...
        if (d.kegiatan) {
          ...
          setKegiatan({
            ...
            :k.||'',vitA_balita_ags:k.vitA_Balita_Ags||'',
  ...
  async function exportExcel() {
    ...
    try {
      ...
      const ws1 = XLSX.utils.aoa_to_sheet([
        ...
        [],
        ['BGM',kegiatan.bawahGarisMerah,'Vit A Bayi Feb',kegiatan.vitA_bayi_feb,'Vit A Bayi Ags',kegiata','Vit A Balita Feb',kegiatan.,'Vit A Balita Ags',kegiatan.vitA_balita_ags],
