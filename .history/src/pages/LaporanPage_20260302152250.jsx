    ...
    <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 12 }}>
      ...
      <tbody>
        ...
        {[
          ...
          <tr
            key={no}
            style={{ background: parseInt(no, 10) % 2 === 0 ? '#FAFAFA' : '#FFF' }}
          >
            <td
              style={{
                ...td,
        ...
        <tr style={{ background: '#EFF6FF' }}>
          ...
          {[
            ...
            const val =
              (Number(kegiatan['n' + col.slice(1)] || 0) || 0) +
              (Number(kegiatan['t' + col.slice(1)] || 0) || 0) +
              (Number(kegiatan['o' + col.slice(1)] || 0) || 0) +
              (Number(kegiatan['b' + col.slice(1)] || 0) || 0);
            return (
              <td
                key={col}
                style={{
                  ...td,
                  borderLeft:
                    idx % 2 === 0 ? '1px solid #BFDBFE' : undefined,
                  fontWeight: 700,
                  color: '#1D4ED8',
                  fontSize: 13,
                }}
        ...
        <tr style={{ background: '#EFF6FF' }}>
          ...
          {[
            ...
            const dCol = col.replace(/^k_/, 's_');
            const kVal = Number(kegiatan[col] || 0) || 0;
            const dVal = Number(kegiatan[dCol] || 0) || 0;
            const val = Math.max(kVal - dVal, 0);
            return (
              <td
                key={col}
                style={{
        ...
        <tr style={{ background: '#FFF7ED' }}>
          ...
          >
            <input
              type="number"
              min="0"
              value={kegiatan.bawahGarisMerah || ''}
              onChange={e =>
                setKegiatan(prev => ({
                  ...prev,
                  bawahGarisMerah: e.target.value,
                }))
              }
            ...
            >
              ...
              >
                ...
                <input
                  type="number"
                  min="0"
                  value={kegiatan.vitA_bayi_feb || ''}
                  onChange={e =>
                    setKegiatan(prev => ({
                      ...prev,
                      vitA_bayi_feb: e.target.value,
                    }))
                  }
              ...
              >
                ...
                <input
                  type="number"
                  min="0"
                  value={kegiatan.vitA_bayi_ags || ''}
                  onChange={e =>
                    setKegiatan(prev => ({
                      ...prev,
                      vitA_bayi_ags: e.target.value,
                    }))
                  }
                  style={{ ...numIn, width: 70 }}
                />
            ...
            >
              ...
              >
                ...
                <input
                  type="number"
                  min="0"
                  value={kegiatan.vitA_balita_feb || ''}
                  onChange={e =>
                    setKegiatan(prev => ({
                      ...prev,
                      vitA_balita_feb: e.target.value,
                    }))
                  }
                  style={{ ...numIn, width: 70 }}
                />
              ...
              >
                ...
                <input
                  type="number"
                  min="0"
                  value={kegiatan.vitA_balita_ags || ''}
                  onChange={e =>
                    setKegiatan(prev => ({
                      ...prev,
                      vitA_balita_ags: e.target.value,
                    }))
                  }
                  style={{ ...numIn, width: 70 }}
                />
        ...
        <tr style={{ background: '#F0FDF4' }}>
          ...
          >
            <input
              type="number"
              min="0"
              value={kegiatan.asiEksklusif || ''}
              onChange={e =>
                setKegiatan(prev => ({
                  ...prev,
                  asiEksklusif: e.target.value,
                }))
              }
              style={{ ...numIn, width: 80 }}
            />
