...
//  PERUBAHAN:
//  - Export Excel dipindah ke ExcelLaporanPage.jsx
//  - Import exportLaporanExcel dari ./Excel/Excel_LaporanPage
//  - Modal ModalExcelInfo muncul sebelum export untuk isi data wilayah
// ============================================================
...
import ModalExcelInfo from './Excel/ModalExcelInfo'; // ← TAMBAHAN
...
export default function LaporanPage({ balitaList = [], currentUser = null }) {
    ...
    try {
      ...
      if (res?.status?.code === 200 && res.data) {
        ...
        if (d.pemantauanRows?.length) setPemRows(d.pemantauanRows.map(r=>({
          ...
          namaIbu:r.namaIbu||'', namaAyah:r.namaAyah||'', namaOrtu:r.namaOrtu||'',
          nikAyah:r.nikAyah||'', noTlp:r.noTlp||'', alamat:r.alamat||'', rt:r.rt||'', rw:r.rw||'',
  ...
  // ── Export Excel — buka modal dulu ──────────────────────────
  // SEBELUM: langsung export
  // SEKARANG: buka ModalExcelInfo → user isi data wilayah → baru export
  async function handleExportExcel() {
    setShowModalExcel(true); // ← buka modal
  }

  // Dipanggil setelah user klik "Buat Excel" di modal
  async function doExportExcel(extraData) {
    ...
    try {
      ...
      const fileName = await exportLaporanExcel({
        ...
        extraData, // ← data wilayah & kader dari modal
      });
      ...
      <Card style={{ marginBottom:16 }}>
        ...
        <div style={{ overflowX:'auto' }}>
          <table style={{ width:'100%', borderCollapse:'collapse', fontSize:12 }}>
            ...
            <tbody>
              {[
                ['01','Jumlah semua balita yang ada dikelompok penimbangan bulan ini','S','#1565C0',
                  ['s_L_0_5','s_P_0_5','s_L_6_11','s_P_6_11','s_L_12_23','s_P_12_23','s_L_24_60','s_P_24_60']],
                ['02','Jumlah balita yang terdaftar dan mempunyai KMS bulan ini','K','#16A34A',
                  ['k_L_0_5','k_P_0_5','k_L_6_11','k_P_6_11','k_L_12_23','k_P_12_23','k_L_24_60','k_P_24_60']],
                ['03','Jumlah balita yang naik berat badannya bulan ini','N','#16A34A',
                  ['n_L_0_5','n_P_0_5','n_L_6_11','n_P_6_11','n_L_12_23','n_P_12_23','n_L_24_60','n_P_24_60']],
                ['04','Jumlah balita yang tidak naik berat badannya bulan ini','T','#DC2626',
                  ['t_L_0_5','t_P_0_5','t_L_6_11','t_P_6_11','t_L_12_23','t_P_12_23','t_L_24_60','t_P_24_60']],
                ['05','Jumlah balita yang ditimbang bulan ini, tetapi tidak ditimbang bulan lalu','O','#D97706',
                  ['o_L_0_5','o_P_0_5','o_L_6_11','o_P_6_11','o_L_12_23','o_P_12_23','o_L_24_60','o_P_24_60']],
                ['06','Jumlah balita yang baru pertama kali hadir di penimbangan bulan ini','B','#9333EA',
                  ['b_L_0_5','b_P_0_5','b_L_6_11','b_P_6_11','b_L_12_23','b_P_12_23','b_L_24_60','b_P_24_60']],
                ['07','Jumlah balita yang ditimbang bulan ini (03+04+05+06)','D','#1D4ED8',
                  ['d_L_0_5','d_P_0_5','d_L_6_11','d_P_6_11','d_L_12_23','d_P_12_23','d_L_24_60','d_P_24_60']],
                ['08','Jumlah balita yang tidak hadir di penimbangan bulan ini (02−07)','-','#1D4ED8',
                  ['m_L_0_5','m_P_0_5','m_L_6_11','m_P_6_11','m_L_12_23','m_P_12_23','m_L_24_60','m_P_24_60']],
                ['09','Jumlah balita yang ada di bawah garis merah (BGM)','A','#D97706',
                  ['bgm_L_0_5','bgm_P_0_5','bgm_L_6_11','bgm_P_6_11','bgm_L_12_23','bgm_P_12_23','bgm_L_24_60','bgm_P_24_60']],
                ['10','Jumlah bayi mendapat vitamin A bulan Februari / Agustus','A','#16A34A',
                ...
                ['11','Jumlah balita mendapat vitamin A bulan Februari / Agustus','A','#16A34A',
                ...
                ['12','Jumlah bayi dengan ASI Eksklusif pada bulan ini','E','#16A34A',
                  ...
                  {fields.map((fieldKey, idx)=>(
                    <td key={fieldKey} style={{ ...td, borderLeft:idx%2===0?'1px solid #E5E7EB':undefined }}>
                      <input type="number" min="0" value={kegiatan[fieldKey]||''}
                        onChange={e=>setKegiatan(prev=>({...prev,[fieldKey]:e.target.value}))}
                        style={numIn}/>
                    </td>
                  ))}
                </tr>
              ...
              <thead>
                <tr>
                  ...
                  {[
                    ...
                    {l:'VitA Feb',w:60},{l:'Buku KIA',w:60},{l:'Perkembangan PKAT',w:120},{l:'',w:34},
