...
export default function App() {
  ...
  // ✅ Log setelah user state benar-benar ter-set
  useEffect(() => {
    if (user) {
      console.log('[App] ✅ User ter-set:', user);
      console.log('[App] nama:', user.nama, '| role:', user.role);
      console.log('[App] ALLOWED_PAGES untuk role ini:', ALLOWED_PAGES[user.role]);
    }
  }, [user]);
