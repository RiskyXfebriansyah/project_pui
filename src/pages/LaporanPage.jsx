...
export default function LaporanPage({ balitaList = [], currentUser = null, onRefresh }) {
  ...
  ...r,
  anakKe:             r.anakKe===''||r.anakKe==null                         ? null : Number(r.anakKe),
  ...
  ...info,
  tanggalPelaksanaan: info.tanggalPelaksanaan || null,
  tanggalPencatatan:  info.tanggalPencatatan  || null,
  jumlahKader: info.jumlahKader === '' ? 0 : Number(info.jumlahKader),
  tahun: info.tahun === '' ? new Date().getFullYear() : Number(info.tahun),
};

setSaving(true);
try {
  const payload = {
    id: laporanId, info: infoNormalized, kegiatan: kegiatanNormalized,
...
<Field 
  label="Nama Posyandu *" 
  value={info.namaPosyandu} 
  disabled={isViewOnly} 
  placeholder="* Wajib diisi"
  onChange={v=>setInfo(p=>({...p,namaPosyandu:v}))}
/>
...
//         maxWidth: 320,
//       }}>
//         Fitur Catatan Bulanan Posyandu sedang dalam pengembangan. Segera hadir!
//       </p>
